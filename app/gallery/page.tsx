...
export const metadata: Metadata = {
  ...
  description:
    "Browse completed landscaping projects across Campbelltown, Camden, Narellan, Picton, and surrounding suburbs. See before and after transformations by Harris Landscaping & Gardens.",
};
  ...
  return (
    <>
        ...
        pairs={[
          {
            ...
            label: "Full Backyard Transformation — Campbelltown",
            before: "/images/before-1.jpg",
          },
          {
            after: "/images/after-2.jpg",
            label: "Paving & Turf Installation — Camden",
            before: "/images/before-2.jpg",
          },
          {
            after: "/images/after-3.jpg",
            label: "Retaining Wall & Garden — Narellan",
            before: "/images/before-3.jpg",
          },
          {
            after: "/images/after-4.jpg",
            label: "Decking & Landscaping — Picton",
      ...
      <Gallery
        images={[
          {
            alt: "Landscaping design project in Campbelltown",
            src: "/images/gallery-1.jpg",
          },
          {
            alt: "Paving installation in Camden",
            src: "/images/gallery-2.jpg",
          },
          {
            alt: "Artificial turf in Narellan",
            src: "/images/gallery-3.jpg",
          },
          {
            alt: "Timber decking in Picton",
            src: "/images/gallery-4.jpg",
          },
          {
            alt: "Retaining wall construction in South-West Sydney",
            src: "/images/gallery-5.jpg",
          },
          {
            alt: "Garden maintenance project in Campbelltown",
            src: "/images/gallery-6.jpg",
          },
          {
            alt: "Natural turf laying in Camden",
            src: "/images/gallery-7.jpg",
          },
          {
            alt: "Irrigation system installation in Narellan",
