...
export const metadata: Metadata = {
  ...
  description:
    "Transform your outdoor space with South-West Sydney's trusted landscapers. Harris Landscaping & Gardens delivers premium landscaping, paving, turf, decking, and garden maintenance across Campbelltown, Camden, Narellan, Picton, and beyond.",
};
      ...
      <GalleryBeforeAfter
        pairs={[
          ...
          },
          {
            ...
            label: "Paving & Turf — Camden",
            before: "/images/before-2.jpg",
          },
          {
            after: "/images/after-3.jpg",
            label: "Decking & Garden — Narellan",
        ...
        items={[
          {
            author: "Sarah M.",
            review:
              "Harris Landscaping completely transformed our backyard. Professional, reliable, and the quality of work is outstanding. Highly recommend!",
            location: "Campbelltown",
          },
          {
            author: "James T.",
            review:
              "From the initial design through to completion, the team was fantastic. Our new paving and turf look incredible.",
            location: "Camden",
          },
          {
            author: "Lisa R.",
            review:
              "We've used Harris Landscaping for both our front and back yard. The attention to detail is second to none — absolute professionals.",
            location: "Narellan",
          },
          {
            author: "David K.",
            review:
              "Exceptional work on our retaining walls and decking. The team showed up on time every day and the results exceeded our expectations.",
            location: "Picton",
          },
        ]}
