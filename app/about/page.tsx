...
export const metadata: Metadata = {
  ...
  description:
    'Harris Landscaping & Gardens has been transforming properties across South-West Sydney for over 15 years with skill, reliability, and genuine care.',
}
...
export default function Page() {
  return (
    <>
      ...
      <AboutValues
        items={[
          { title: 'Quality Craftsmanship', description: 'Every project is completed to the highest standard, using premium materials and proven techniques that stand the test of time.' },
          { title: 'Reliable & Professional', description: 'We show up on time, communicate clearly, and follow through on every commitment — so you can trust the process from start to finish.' },
          { title: 'Full-Project Approach', description: 'From design concept to final clean-up, we manage your entire landscaping project so you get a seamless, stress-free experience.' },
        ]}
